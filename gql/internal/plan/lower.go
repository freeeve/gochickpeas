...
// assignment, scan-source selection, hop building, var-length
// hop-predicate extraction, projection binding, and the shared AND-chain
// helpers. The anchor-seek recognizers live in lower_seeks.go.
package plan
