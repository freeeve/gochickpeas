// Substitution-layer tests for the fusion pass (rewrite.go): substExpr's
// per-kind rewrite/decline behavior and inlineProjection's boundary
// rewrite. The pass-level fusion tests stay in rewrite_test.go.
package plan
