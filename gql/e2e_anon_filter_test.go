...
func namesParam(t *testing.T, g *chickpeas.Snapshot, q, p string) []string {
	t.Helper()
	rows, err := gql.RunWithParams(g, q, map[string]value.Value{"p": value.Str(p)})
	if err != nil {
...
func TestAnonDestInlinePropFilter(t *testing.T) {
	...
	gql.WantStrs(t, strCol(t, g, named, "name"), "Alice", "Bob")
	// The bug shape: anonymous destination must match identically, not 0 rows.
	gql.WantStrs(t, strCol(t, g, anon, "name"), "Alice", "Bob")
	...
	gql.WantStrs(t, strCol(t, g, namedCity, "name"), "Alice", "Bob")
	gql.WantStrs(t, strCol(t, g, anonCity, "name"), "Alice", "Bob")
	...
	gql.WantStrs(t, namesParam(t, g, anonParam, "Acme"), "Alice", "Bob")
	...
	gql.WantStrs(t, namesParam(t, g, anonParam, "Globex"), "Carol")
}
